package com.regulus.airplanetypeservice.dtos;
...
public class AirplaneTypeDto {
    ...
    public AirplaneTypeDto(int airplane_type_id, String airplane_type_identifier, String description) {
        this.airplane_type_id = airplane_type_id;
        this.airplane_type_identifier = airplane_type_identifier;
        this.description = description;
    }

    public AirplaneTypeDto() {
    }
